...
<html>
<head>
  <title>Formulario de Registro de CAC</title>
...
<body>
    ...
    <div class="column21">
   <center>
    <h3>Coordinación de Aseguramiento de la Calidad</h3>
  ...
  <div class="basis">
    ...
    <div class="column3">
      <button type="button" name="Modificar" class="button-gray button-black-text">
    ...
    <div class="basis">
      ...
      <div class="extra-column">
        ...
        <br><br>
        <center>
        <button type="submit" name="register" class="button-gray button-black-text">
